...
optional
    ...
    effect_allele_is_alt : bool, default False
        ...
        a second pass over each chunk (the pass that credits homozygous-
        reference samples at variants whose effect allele is the reference
        base), which can roughly halve the run time.
